package com.myp.huiao.widget.superadapter;
...
import com.myp.huiao.widget.superadapter.base.ItemViewDelegate;
import com.myp.huiao.widget.superadapter.base.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends BaseAdapter {
     ...
     * 加入一个标记,用于记录某一个下标被点击
     */
    public void setChecks(int checked) {
