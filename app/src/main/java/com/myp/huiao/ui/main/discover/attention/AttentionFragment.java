...
public class AttentionFragment extends MVPBaseFragment<AttentionContract.View,
        AttentionPresenter> implements AttentionContract.View {
    ...
    @Override
    public void getTopicList(final List<TopicBO> topicBOs) {
        LGRecycleViewAdapter<TopicBO> adapter = new LGRecycleViewAdapter<TopicBO>(topicBOs) {
            ...
            public void convert(LGViewHolder holder, TopicBO topicBO, int position) {
                holder.getView(R.id.add_guanzhu).setVisibility(View.GONE);
